    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': (('registrar_entrada', 'Pode registrar a entrada de um veículo no estacionamento'), ('finalizar_saida', 'Pode calcular e finalizar a saída e pagamento do veículo'), ('visualizar_vagas', 'Pode visualizar o mapa de vagas e registros ativos')),
            },
        ),
    ]
